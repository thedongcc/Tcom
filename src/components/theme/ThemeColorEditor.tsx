    ...
    return (
        ...
        >
            <div className="flex-1 flex flex-col bg-[var(--theme-editor-bg)] overflow-hidden relative">
                ...
                {/* 搜索 + 检查器 */}
                <div className="px-3 py-2 border-b shrink-0 flex flex-col gap-1.5" style={{ WebkitAppRegion: 'no-drag', borderColor: 'var(--theme-editor-border)' } as any}>
                    ...
                    >
                        {isInspecting ? (
                            <><X size={12} className="animate-pulse" /><span>停止选取 (ESC)</span></>
                        ) : (
                            <><Crosshair size={12} /><span className="tracking-wide">开启 UI 元素选取匹配</span></>
                        )}
                    </button>
                </div>
                ...
                <div className="flex-1 overflow-hidden relative group/scroll-container">
                    ...
                    >
                        ...
                        {filteredGroups.length === 0 ? (
                            <div className="text-center py-10 text-[var(--app-foreground)]/40 text-[11px]">未查找到匹配的颜色变量</div>
                        ) : (
                ...
                {/* 底部操作栏 */}
                <div className="px-3 py-2 border-t flex justify-end gap-2 shrink-0" style={{ WebkitAppRegion: 'no-drag', borderColor: 'var(--theme-editor-border)', backgroundColor: 'var(--theme-editor-card-bg)' } as any}>
                    <button
