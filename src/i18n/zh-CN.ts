...
export const zhCN = {
    ...
    settings: {
        ...
        keybindings: {
            toggleSearch: '搜索切换',
            toggleSearchDesc: '打开或关闭监视器内的搜索栏',
            saveCommand: '保存命令 / 发送',
    ...
    themeEditor: {
        ...
        copyVar: '点击复制变量名',
        copied: '已复制！',
        searchPlaceholder: '搜索变量、组件名、CSS 名...',
        stopInspect: '停止选取 (ESC)',
        startInspect: '开启 UI 元素选取匹配',
        pickedOuterHTML: '选取元素 outerHTML',
        noInfo: '无信息',
        matchedVars: '匹配到的颜色变量',
        pickedSelf: '当前元素内联',
        pickedParent: '沿级父代继承',
        pickedComponent: '组件关联变量',
        pickedOther: '深层子项及其他',
        ...
        original: '原始',
        copyVarName: '点击复制变量名',
        copyOriginal: '点击复制原色值',
        copyNewValue: '点击复制新色值',
        discardChanges: '放弃更改',
        saveChanges: '保存更改',
    },
    ...
    update: {
        title: '软件更新',
        checking: '正在检查更新...',
        upToDate: '您的软件已是最新版本 (v{version})',
        errorChecking: '检查更新时出错',
        networkHint: '若是网络问题，请尝试手动下载',
        manualDownload: '手动下载',
        newVersion: '发现新版本: v{version}',
        releaseDate: '发布日期: {date}',
        releaseDateUnknown: '未知',
        changelog: '更新日志:',
        noChangelog: '暂无详细更新说明',
        later: '稍后再说',
        manualHint: '若自动下载失败请尝试此选项',
        downloadNow: '立即下载',
        downloading: '正在下载更新...',
        downloadSlow: '下载太慢或失败？尝试手动下载',
        downloaded: '更新已下载完成',
        installHint: '软件将自动关闭并开始安装更新',
        installLater: '稍后安装',
        installNow: '立即重启并安装',
        initializing: '正在初始化...',
    },
